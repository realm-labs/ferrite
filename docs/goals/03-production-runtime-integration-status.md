...
| `G03-P3-B3` | `InProgress` | P3-B2 | — | Adding deterministic ingress-to-projection replay and fault proofs |
...
| Final state | Pending |
| Completion commit | — |
| Remaining required work | `G03-P3-B3` through `G03-P4-B2` |
