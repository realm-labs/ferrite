...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-F008` |
| Next unblocked batch | `G01-P6-F009` |
...
| Manifest SHA-256 | `f6ac1e90d99791ab91eaaaaf549f18dcf029029ba1f982f5fda54269eafc2b2f` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 21 | 0 | 23 |
