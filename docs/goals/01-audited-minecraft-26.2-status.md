...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S009` |
| Next unblocked batch | `G01-P6-S010` |
...
| Manifest SHA-256 | `5059638b9b976b41e6773786f8121aeeb994c8cef1509bf906a9a0f3838f865e` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 172 | 0 | 155 |
...
| Gameplay slice partitions | 55 | 331 slices | 174 | 157 |
