...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S006` |
| Next unblocked batch | `G01-P6-S007` |
...
| Manifest SHA-256 | `b8e99d110b6c15a8d7f65962e99f9d5c1457c916a209e64f727ec5f0d9d3560d` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 168 | 0 | 159 |
...
| Gameplay slice partitions | 55 | 331 slices | 170 | 161 |
