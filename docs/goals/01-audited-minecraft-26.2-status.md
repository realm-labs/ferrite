...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-F010` |
| Next unblocked batch | `G01-P6-B2` |
...
| Manifest SHA-256 | `0159c81d97b569ead3159c640d306638dcb9f110f15ccca43df35413449afef2` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 23 | 0 | 21 |
