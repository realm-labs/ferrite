...
| State | `InProgress` |
| Active batch | None |
| Next unblocked batch | `G01-P3-F003` |
...
| Manifest SHA-256 | `1e8cfb04457d31aa09b0ee53d3f66483483a02d1bbf5c03b633810872313ce14` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 2 | 0 | 42 |
...
| Phase 3 — Protocol C0 and C1 | `InProgress` | [wire foundation](../development/protocol-wire.md), [packet catalog](../development/protocol-catalog.md), [required clientbound configuration](../development/protocol-configuration-clientbound.md), and [required serverbound configuration](../development/protocol-configuration-serverbound.md) | Bounded transport, locked dispatch, and both required configuration directions pass |
...
| Required protocol partitions | 44 | 44 families | 2 | 42 |
