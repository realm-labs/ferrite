...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P8-S005` |
| Next unblocked batch | `G01-P8-B1` |
...
| Manifest SHA-256 | `942de6b4b92422fa9864441d89aa25f8b98402d07efda0b81865aec20d5a5f13` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 322 | 0 | 5 |
