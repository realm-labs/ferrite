...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-B2` |
| Next unblocked batch | `G01-P8-S001` |
...
| Phase 7 — Entities, combat, mobs, AI, and spawning | `InProgress` | [Region integration](../development/phase7-region-integration.md); [G01-P7-B1 report](../reports/goal-01/g01-p7-b1-region-integration.md); complete slice/family evidence remains indexed by the implementation manifest | All 56 entity/mob gameplay slices and all seven Phase 7 protocol families are verified; lifecycle, transfer, persistence, and bounded tracking are integrated; `G01-P7-B2` is active |
