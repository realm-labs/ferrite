...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S007` |
| Next unblocked batch | `G01-P6-S008` |
...
| Manifest SHA-256 | `4d2385e6d6bd012aa3fbe240dc3a7df60f8ce669d4b8db512379304e44de4f84` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 169 | 0 | 158 |
...
| Gameplay slice partitions | 55 | 331 slices | 171 | 160 |
