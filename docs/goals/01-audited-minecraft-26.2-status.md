...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P5-S018` |
| Next unblocked batch | `G01-P5-S019` |
...
| Manifest SHA-256 | `470eb0df4260535cb9e2bac212c62ae9ca8eb13737d0b90e40c9fbbf3be632e0` |
| Completion commit | — |
| Blocker | None |
...
| Gameplay slice partitions | 55 | 331 slices | 138 | 193 |
