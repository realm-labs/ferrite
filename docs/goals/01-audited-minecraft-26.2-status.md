...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F008` |
| Next unblocked batch | `G01-P9-F009` |
...
| Manifest SHA-256 | `de8072038e72503553d0c9f42dd29590f4402e0ef1365f423fc005058ec6b81d` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 38 | 0 | 6 |
