...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O005` |
| Next unblocked batch | `G01-P9-O006` |
...
| Manifest SHA-256 | `4167034cd85d810cccdf10a255e7ed48a1184673a66a1d493ef55fa48190577d` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 4 | 0 | 10 |
...
| Optional protocol gate partitions | 14 | 14 families | 4 | 10 |
