...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-S002` |
| Next unblocked batch | `G01-P7-S003` |
...
| Manifest SHA-256 | `bcae79a79788587ea953f120e8020070d12af0c9154fce3b3b3be7fac10bffe2` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 277 | 0 | 50 |
...
| Phase 7 — Entities, combat, mobs, AI, and spawning | `InProgress` | [ENT-001 runtime](../development/entity-runtime-ent-001.md); [G01-P7-S001 report](../reports/goal-01/g01-p7-s001-ent-001-entities.md) | 37 entity slices are verified; `G01-P7-S002` is active |
...
| Gameplay slice partitions | 55 | 331 slices | 280 | 51 |
