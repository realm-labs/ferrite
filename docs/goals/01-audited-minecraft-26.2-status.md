...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P8-B3` |
| Next unblocked batch | `G01-P9-S001` |
...
| Manifest SHA-256 | `ff7b18f5dad1a4b32090dccf00ad738557f0bbde80f0d481e9aa7e68d85df7e5` |
| Completion commit | — |
| Blocker | None |
...
| `G01-P8-B3` | `InProgress` | P8-B2 | — | Record equivalence deferral |
