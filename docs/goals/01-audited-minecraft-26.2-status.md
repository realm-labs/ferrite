...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O012` |
| Next unblocked batch | `G01-P9-O013` |
...
| Manifest SHA-256 | `6ff7c0d56b73b1b30c5ad9d2729e45a00ac1a2b6aa49b6a4fe2b7fdd216905d4` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 11 | 0 | 3 |
