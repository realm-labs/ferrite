...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S001` |
| Next unblocked batch | `G01-P6-S002` |
...
| Manifest SHA-256 | `727ba4e502f0696cdd0d7397549ff455b08df37acc96b8037ccb65b628310c69` |
| Completion commit | — |
| Blocker | None |
...
| Phase 6 — Players, items, inventories, and progression | `InProgress` | — | `G01-P6-S001` item slices owned by BLK-001 are active |
