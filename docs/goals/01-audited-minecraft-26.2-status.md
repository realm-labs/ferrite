...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P5-B1` |
| Next unblocked batch | `G01-P5-B2` |
...
| Manifest SHA-256 | `79323acb11183fc240c63109668dad4457eb19c9a485c8f7ae91b1da3c6a2b71` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 138 | 0 | 189 |
| Source-known surface of inconclusive slices | 4 | 2 | 4 observations | 2 implementations |
...
| `G01-P5-B1` | `InProgress` | Phase 5 slice batches | — | Integrate continuity and projection |
...
| Gameplay slice partitions | 55 | 331 slices | 140 | 191 |
