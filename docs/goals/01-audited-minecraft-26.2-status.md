...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-B1` |
| Next unblocked batch | `G01-P7-B2` |
...
| Phase 7 — Entities, combat, mobs, AI, and spawning | `InProgress` | [serverbound entity session](../development/protocol-play-serverbound-entity-session.md); [G01-P7-F007 report](../reports/goal-01/g01-p7-f007-play-serverbound-entity-session.md); complete slice/family evidence remains indexed by the implementation manifest | All 56 entity/mob gameplay slices and all seven Phase 7 protocol families are verified; `G01-P7-B1` is active |
