...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-S004` |
| Next unblocked batch | `G01-P7-S005` |
...
| Manifest SHA-256 | `a14aae304559f60cd499b49c10d27aea6329624441a3afecbc826f5ffb544db7` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 279 | 0 | 48 |
...
| Phase 7 — Entities, combat, mobs, AI, and spawning | `InProgress` | [ENT-001 runtime](../development/entity-runtime-ent-001.md); [G01-P7-S001 report](../reports/goal-01/g01-p7-s001-ent-001-entities.md); [vehicle runtime](../development/entity-vehicle-runtime.md); [G01-P7-S002 report](../reports/goal-01/g01-p7-s002-vehicles.md); [projectile runtime](../development/entity-projectile-runtime.md); [G01-P7-S003 report](../reports/goal-01/g01-p7-s003-projectiles.md) | 39 entity slices are verified; `G01-P7-S004` is active |
...
| Gameplay slice partitions | 55 | 331 slices | 282 | 49 |
