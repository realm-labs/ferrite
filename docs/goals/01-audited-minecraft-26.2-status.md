...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-F002` |
| Next unblocked batch | `G01-P6-F003` |
...
| Manifest SHA-256 | `ec4182e21246cf2c7e3e45e985b7ddbf9f4dcb6d6441a49045572ae53ff2192b` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 15 | 0 | 29 |
