...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S002` |
| Next unblocked batch | `G01-P6-S003` |
...
| Manifest SHA-256 | `dc313b4ddfe5893e0ee839e31df75435a823f108475576a441663fd3d5ba28e1` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 148 | 0 | 179 |
...
| Phase 6 — Players, items, inventories, and progression | `InProgress` | [BLK-001-owned item runtime](../development/item-runtime-blk-001.md); [G01-P6-S001 report](../reports/goal-01/g01-p6-s001-item-runtime.md) | Ten item slices and eighteen identities verified; `G01-P6-S002` is active |
...
| Gameplay slice partitions | 55 | 331 slices | 150 | 181 |
