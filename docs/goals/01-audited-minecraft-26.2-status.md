...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-S003` |
| Next unblocked batch | `G01-P7-S004` |
...
| Manifest SHA-256 | `382447f3a1d4457dd79260c9ddba56fa70d5df5313e6e712b1de054682be7122` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 278 | 0 | 49 |
...
| Phase 7 — Entities, combat, mobs, AI, and spawning | `InProgress` | [ENT-001 runtime](../development/entity-runtime-ent-001.md); [G01-P7-S001 report](../reports/goal-01/g01-p7-s001-ent-001-entities.md); [vehicle runtime](../development/entity-vehicle-runtime.md); [G01-P7-S002 report](../reports/goal-01/g01-p7-s002-vehicles.md) | 38 entity slices are verified; `G01-P7-S003` is active |
...
| Gameplay slice partitions | 55 | 331 slices | 281 | 50 |
