...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P5-S003` |
| Next unblocked batch | `G01-P5-S004` |
...
| Manifest SHA-256 | `2fbcd76395d23d82e1a6429b0ccb9bfb61be6b821c1bcc8a795e09d2ad171a16` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 44 | 0 | 283 |
...
| Phase 5 — Simulation, blocks, environment, and redstone | `InProgress` | [BLK-001 runtime](../development/block-runtime-blk-001.md), [placement and breaking](../development/block-placement-and-breaking.md), [G01-P5-S001 report](../reports/goal-01/g01-p5-s001-block-runtime.md), and [G01-P5-S002 report](../reports/goal-01/g01-p5-s002-placement-and-breaking.md) | 44 source-specified slices verified; next batch is `G01-P5-S003` |
...
| Gameplay slice partitions | 55 | 331 slices | 44 | 287 |
