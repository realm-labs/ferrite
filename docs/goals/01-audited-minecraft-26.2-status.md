...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-F005` |
| Next unblocked batch | `G01-P6-F006` |
...
| Manifest SHA-256 | `7c5d8ca1e6e013665afa2d8e4f736f8721975020bc08b60a56b0c4d9265b52d4` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 18 | 0 | 26 |
