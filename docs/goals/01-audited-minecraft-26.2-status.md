...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O010` |
| Next unblocked batch | `G01-P9-O011` |
...
| Manifest SHA-256 | `256431642720c50c1fe4cc6439dc719db3fc4c52f4cbbe17dce39976d2e0410a` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 9 | 0 | 5 |
