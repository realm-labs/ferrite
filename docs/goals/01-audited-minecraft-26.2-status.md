...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S008` |
| Next unblocked batch | `G01-P6-S009` |
...
| Manifest SHA-256 | `a925c162db9965e76fc65116c1ffde598cf764307866f33e87eb93732bfe3f6f` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 171 | 0 | 156 |
...
| Gameplay slice partitions | 55 | 331 slices | 173 | 158 |
