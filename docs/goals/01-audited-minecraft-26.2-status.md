...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O011` |
| Next unblocked batch | `G01-P9-O012` |
...
| Manifest SHA-256 | `8de75bf993a4b7afd224cfd09ce41730a1b7d6a2cb0c5cc209e24b8e00349ea2` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 10 | 0 | 4 |
