...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F011` |
| Next unblocked batch | `G01-P9-F012` |
...
| Manifest SHA-256 | `e527ff347cdb54cf74766a7c4b3680c5933ceaee732fde56333a9cf652d64d4f` |
| Completion commit | — |
| Blocker | None |
...
| Required protocol partitions | 44 | 44 families | 41 | 3 |
