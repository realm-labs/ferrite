...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P5-S004` |
| Next unblocked batch | `G01-P5-S005` |
...
| Manifest SHA-256 | `a9a5c97d948ddf6a10b07840244c2e8d13ae3250c1cf9e917d2cc77f813ca5ef` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 50 | 0 | 277 |
...
| Phase 5 — Simulation, blocks, environment, and redstone | `InProgress` | [BLK-001 runtime](../development/block-runtime-blk-001.md), [placement and breaking](../development/block-placement-and-breaking.md), [BLK-003 update/runtime](../development/block-update-and-runtime-blk-003.md), [G01-P5-S001 report](../reports/goal-01/g01-p5-s001-block-runtime.md), [G01-P5-S002 report](../reports/goal-01/g01-p5-s002-placement-and-breaking.md), and [G01-P5-S003 report](../reports/goal-01/g01-p5-s003-block-update-and-runtime.md) | 50 source-specified slices verified; next batch is `G01-P5-S004` |
...
| Gameplay slice partitions | 55 | 331 slices | 50 | 281 |
