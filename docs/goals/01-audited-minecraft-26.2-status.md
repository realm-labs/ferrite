...
| State | `InProgress` |
| Active batch | None |
| Next unblocked batch | `G01-P3-F008` |
...
| Manifest SHA-256 | `7bf199ed714ba2669be4bd89dd2ef245791e63f4fbb85c5a9458469fbd80be21` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 7 | 0 | 37 |
...
| Required protocol partitions | 44 | 44 families | 7 | 37 |
