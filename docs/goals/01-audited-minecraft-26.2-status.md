...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P5-S002` |
| Next unblocked batch | `G01-P5-S003` |
...
| Manifest SHA-256 | `2ae3818a7bcb0a5c9e4ef8989eb7bd3ddf98c23409765c66a0640a050d3fdbbe` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 41 | 0 | 286 |
...
| Phase 5 — Simulation, blocks, environment, and redstone | `InProgress` | [BLK-001 runtime](../development/block-runtime-blk-001.md) and [G01-P5-S001 report](../reports/goal-01/g01-p5-s001-block-runtime.md) | 41 source-specified slices verified; next batch is `G01-P5-S002` |
...
| Gameplay slice partitions | 55 | 331 slices | 41 | 290 |
