...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-F004` |
| Next unblocked batch | `G01-P6-F005` |
...
| Manifest SHA-256 | `f6ac011f0bcce680160cda760ab686ca6fe3953b76db9da30906ffecc92ceb3d` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 17 | 0 | 27 |
