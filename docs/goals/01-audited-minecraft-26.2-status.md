...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-F001` |
| Next unblocked batch | `G01-P7-F002` |
...
| Manifest SHA-256 | `c5ec659ad5460692bbddccf9e87713c4fd58ad9dbba0a7f4b9abbc5a08540b57` |
| Completion commit | — |
| Blocker | None |
