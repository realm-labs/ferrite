...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P8-B1` |
| Next unblocked batch | `G01-P8-B2` |
...
| `G01-P8-B1` | `InProgress` | Phase 8 slice batches | — | Integrate durable worlds |
