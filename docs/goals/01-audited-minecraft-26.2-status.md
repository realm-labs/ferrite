...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-F003` |
| Next unblocked batch | `G01-P6-F004` |
...
| Manifest SHA-256 | `bcbc8087d77996c53ec7f90535e230ad6d1bd3280fc6196c3b945062022c93fc` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 16 | 0 | 28 |
