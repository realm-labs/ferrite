...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F002` |
| Next unblocked batch | `G01-P9-F003` |
...
| Manifest SHA-256 | `34d5e2ddb9d6298e51bb447b6579938108a6f906a91c7e8c07dd84aada21f5a3` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 32 | 0 | 12 |
...
| Required protocol partitions | 44 | 44 families | 32 | 12 |
