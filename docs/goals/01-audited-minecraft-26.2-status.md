...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S012` |
| Next unblocked batch | `G01-P6-S013` |
...
| Manifest SHA-256 | `d811f02f699d88d6177e098b0c6e2dd8028137087d7daa3868cd8c5ab0cd4b93` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 218 | 0 | 109 |
...
| Gameplay slice partitions | 55 | 331 slices | 220 | 111 |
