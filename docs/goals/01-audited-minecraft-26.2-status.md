...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O006` |
| Next unblocked batch | `G01-P9-O007` |
...
| Manifest SHA-256 | `2964c184acc65ebc3935917302c1645561bac1b54419158c6ef0ea91c7c8549f` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 5 | 0 | 9 |
...
| Optional protocol gate partitions | 14 | 14 families | 5 | 9 |
