...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S015` |
| Next unblocked batch | `G01-P6-S016` |
...
| Manifest SHA-256 | `b6d63ce4c06a2ba4056351b9267cb9ec9ae8ce7ecba46f1f15c7ed167bc71330` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 239 | 0 | 88 |
...
| Gameplay slice partitions | 55 | 331 slices | 241 | 90 |
