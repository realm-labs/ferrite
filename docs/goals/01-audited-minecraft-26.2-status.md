...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-F004` |
| Next unblocked batch | `G01-P7-F005` |
...
| Manifest SHA-256 | `30481376b5de5e8bb7ffd5f46c44fdc4c95f97f496bfea02a2bb35256db337b2` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 27 | 0 | 17 |
