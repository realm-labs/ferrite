...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S011` |
| Next unblocked batch | `G01-P6-S012` |
...
| Manifest SHA-256 | `cadfc100ebe5f3f7900d3f20fc8f1e8b7426e12939fbe8da415c9097f7822803` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 217 | 0 | 110 |
...
| Gameplay slice partitions | 55 | 331 slices | 219 | 112 |
