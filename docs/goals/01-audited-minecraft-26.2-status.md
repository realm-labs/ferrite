...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O013` |
| Next unblocked batch | `G01-P9-O014` |
...
| Manifest SHA-256 | `6bc1528b6941ab8b1e4c001f56e5628602cc74324408459725bc5244c57a37e1` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 12 | 0 | 2 |
