...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-S001` |
| Next unblocked batch | `G01-P7-S002` |
...
| Manifest SHA-256 | `9649ac24e683224177821dc59528acdeec30d1224ccff085e7616129c9374072` |
| Completion commit | — |
| Blocker | None |
...
| Phase 7 — Entities, combat, mobs, AI, and spawning | `InProgress` | — | `G01-P7-S001` is active |
