...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S016` |
| Next unblocked batch | `G01-P6-B1` |
...
| Manifest SHA-256 | `3eb2dc7e8c56dc9a9afc2e690b2528ca520ad0bbab537b3bfb8b9889348a21bf` |
| Completion commit | — |
| Blocker | None |
