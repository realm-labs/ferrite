...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F012` |
| Next unblocked batch | `G01-P9-F013` |
...
| Manifest SHA-256 | `32a3797e0dc143a0f95c9803663311cbcc10220affdfd72b88818f9519a484ff` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 41 | 0 | 3 |
...
| Required protocol partitions | 44 | 44 families | 42 | 2 |
