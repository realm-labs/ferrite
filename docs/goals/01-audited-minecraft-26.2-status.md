...
| Phase 4 — C2 minimal playable multi-Region world | `InProgress` | [Chunk join projection](../development/chunk-join-projection.md), [player movement and transfer](../development/player-movement-and-region-transfer.md), [block interaction and convergence](../development/block-interaction-and-convergence.md), [P4-B1 report](../reports/goal-01/g01-p4-b1-chunk-join-projection.md), [P4-B2 report](../reports/goal-01/g01-p4-b2-player-movement-and-transfer.md), and [P4-B3 report](../reports/goal-01/g01-p4-b3-block-interaction-and-convergence.md) | Join, terrain, movement, liveness, transfer, block mutation, prediction ACK, correction, and committed aggregation pass; topology and client acceptance remain |
