...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O014` |
| Next unblocked batch | `G01-P9-B1` |
...
| Manifest SHA-256 | `aa2582fa8a1af5a5cbe8b13b1b2712eab8549af59a03e63915e3be62a99e07a9` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 13 | 0 | 1 |
