...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-F006` |
| Next unblocked batch | `G01-P7-F007` |
...
| Manifest SHA-256 | `9e98a6677d0d2b1e4b175dab1ca86ca37f56edc5e7de6870bf5cd39eb22bca1d` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 29 | 0 | 15 |
