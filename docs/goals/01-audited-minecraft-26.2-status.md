...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-S011` |
| Next unblocked batch | `G01-P7-F001` |
...
| Manifest SHA-256 | `8c498ff713e00d204d61d5e24103818f884cb86205821b07246a77ee4e50582c` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 295 | 0 | 32 |
