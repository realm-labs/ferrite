...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O009` |
| Next unblocked batch | `G01-P9-O010` |
...
| Manifest SHA-256 | `bb34799abd29ea5fd394bf6c454350266fe9b2486211ecfa62216f8f71b35138` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 8 | 0 | 6 |
