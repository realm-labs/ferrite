...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O004` |
| Next unblocked batch | `G01-P9-O005` |
...
| Manifest SHA-256 | `9177d5d5f8c920075fcc1580b0bb513ed7a2815a8a41f252a51bcae40d48afbb` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 3 | 0 | 11 |
...
| Optional protocol gate partitions | 14 | 14 families | 3 | 11 |
