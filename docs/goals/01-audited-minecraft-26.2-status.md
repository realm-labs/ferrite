...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-F009` |
| Next unblocked batch | `G01-P6-F010` |
...
| Manifest SHA-256 | `ee400b0cfd82a27628d986a9df6e2e1d944cdd18cbbe9558e36dd2f86b4fa282` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 22 | 0 | 22 |
