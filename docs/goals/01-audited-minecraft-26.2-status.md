...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-F002` |
| Next unblocked batch | `G01-P7-F003` |
...
| Manifest SHA-256 | `0c538c23cb069f22787285eb7ce401db32203277ab426eb1eaa26d6c921b87ee` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 25 | 0 | 19 |
