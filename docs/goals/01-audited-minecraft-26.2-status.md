...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F005` |
| Next unblocked batch | `G01-P9-F006` |
...
| Manifest SHA-256 | `85cf4f27bc08654a67e3d46018d84dd5af55549758470b363340dc4f6cdf7532` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 35 | 0 | 9 |
...
| Required protocol partitions | 44 | 44 families | 35 | 9 |
