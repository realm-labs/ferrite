...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F001` |
| Next unblocked batch | `G01-P9-F002` |
...
| Manifest SHA-256 | `39cba7dc63f68d938d20b2d1740ca294a822a179fe4e5ea30ef7571b987f6d06` |
| Completion commit | — |
| Blocker | None |
