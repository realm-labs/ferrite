...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P7-F005` |
| Next unblocked batch | `G01-P7-F006` |
...
| Manifest SHA-256 | `9fa84b9c02717ff389fb7007792475bb70c6fbc1e8fe892d264d8e6e88699acd` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 28 | 0 | 16 |
