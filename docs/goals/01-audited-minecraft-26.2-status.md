...
| Phase 4 — C2 minimal playable multi-Region world | `InProgress` | [Chunk join projection](../development/chunk-join-projection.md) and [P4-B1 report](../reports/goal-01/g01-p4-b1-chunk-join-projection.md) | Join-to-wire chunk projection passes full gates; movement, interaction, topology, and client acceptance remain |
...
| `G01-P4-B2` | `InProgress` | P4-B1 | — | Add movement and transfer |
