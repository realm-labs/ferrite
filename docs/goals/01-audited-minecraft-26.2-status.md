...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F010` |
| Next unblocked batch | `G01-P9-F011` |
...
| Manifest SHA-256 | `b4fb5698efca60ffae881a6658045da4e7772c703bc6ced54e676a78492024af` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 40 | 0 | 4 |
...
| Required protocol partitions | 44 | 44 families | 40 | 4 |
