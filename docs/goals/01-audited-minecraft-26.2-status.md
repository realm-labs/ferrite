...
| State | `InProgress` |
| Active batch | None |
| Next unblocked batch | `G01-P3-F009` |
...
| Manifest SHA-256 | `c9791de397110ae1069e12b64de3f356269ca258a9e6ab8cb0e197c11dd7a1e1` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 8 | 0 | 36 |
...
| Phase 3 — Protocol C0 and C1 | `InProgress` | [wire foundation](../development/protocol-wire.md), [packet catalog](../development/protocol-catalog.md), [handshake](../development/protocol-handshake-serverbound.md), [clientbound status](../development/protocol-status-clientbound.md), required [clientbound](../development/protocol-login-clientbound.md)/[serverbound](../development/protocol-login-serverbound.md) login, [clientbound](../development/protocol-play-clientbound-entry.md)/[serverbound](../development/protocol-play-serverbound-entry.md) Play entry, and both [clientbound](../development/protocol-configuration-clientbound.md)/[serverbound](../development/protocol-configuration-serverbound.md) configuration directions | Bounded transport, locked dispatch, terminal intention routing, normalized status projection, complete required offline login ordering, both required configuration directions, and the ordered Play entry plus teleport acknowledgement/resend lifecycle pass |
...
| Required protocol partitions | 44 | 44 families | 8 | 36 |
