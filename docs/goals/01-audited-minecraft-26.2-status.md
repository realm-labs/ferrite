...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S003` |
| Next unblocked batch | `G01-P6-S004` |
...
| Manifest SHA-256 | `a06f4719a03c4ae6e5aa8d97f022a108353194fc2f8defa1b41a9948180c9ff0` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 149 | 0 | 178 |
...
| Phase 6 — Players, items, inventories, and progression | `InProgress` | [BLK-001-owned item runtime](../development/item-runtime-blk-001.md), [Prismarine item runtime](../development/prismarine-item-runtime.md), [G01-P6-S001 report](../reports/goal-01/g01-p6-s001-item-runtime.md), and [G01-P6-S002 report](../reports/goal-01/g01-p6-s002-prismarine-item-runtime.md) | Eleven item slices and twenty identities verified; `G01-P6-S003` is active |
...
| Gameplay slice partitions | 55 | 331 slices | 151 | 180 |
