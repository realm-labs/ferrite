...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-F007` |
| Next unblocked batch | `G01-P9-F008` |
...
| Manifest SHA-256 | `fa2ab3c6ef0e1f19badec6d1d5c5b13c242dc7b4e60ed47bfc48bee8a88d3764` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 37 | 0 | 7 |
