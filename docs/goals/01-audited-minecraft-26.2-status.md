...
| Phase 4 — C2 minimal playable multi-Region world | `InProgress` | [Chunk join projection](../development/chunk-join-projection.md), [player movement and transfer](../development/player-movement-and-region-transfer.md), [P4-B1 report](../reports/goal-01/g01-p4-b1-chunk-join-projection.md), and [P4-B2 report](../reports/goal-01/g01-p4-b2-player-movement-and-transfer.md) | Join, terrain, player movement, correction, liveness, and commit-fenced Region transfer pass; interaction, topology, and client acceptance remain |
...
| `G01-P4-B3` | `InProgress` | P4-B2 | — | Add block interaction and correction |
