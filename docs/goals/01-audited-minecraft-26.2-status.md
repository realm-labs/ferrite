...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S013` |
| Next unblocked batch | `G01-P6-S014` |
...
| Manifest SHA-256 | `b5e05b884ffbfe4ceb83176f4d48725199e50424bf6a359ae2c2bb23982f2922` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 233 | 0 | 94 |
...
| Gameplay slice partitions | 55 | 331 slices | 235 | 96 |
