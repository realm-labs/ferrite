...
| State | `InProgress` |
| Active batch | None |
| Next unblocked batch | `G01-P3-F002` |
...
| Manifest SHA-256 | `b14912cc1317d30d1f0ad6f01f064236d6256178ffd78668dc6d6502c97b9d66` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 1 | 0 | 43 |
...
| Phase 3 — Protocol C0 and C1 | `InProgress` | [wire foundation](../development/protocol-wire.md), [packet catalog](../development/protocol-catalog.md), and [required clientbound configuration](../development/protocol-configuration-clientbound.md) | Bounded transport, locked dispatch, and the first required C1 family pass |
...
| Required protocol partitions | 44 | 44 families | 1 | 43 |
