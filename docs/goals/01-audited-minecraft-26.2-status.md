...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S014` |
| Next unblocked batch | `G01-P6-S015` |
...
| Manifest SHA-256 | `cceae0921cc52fd8535a1180b4f4e5b7cea041331be99f483c52f27dedf86368` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 238 | 0 | 89 |
...
| Gameplay slice partitions | 55 | 331 slices | 240 | 91 |
