...
| State | `InProgress` |
| Active batch | None |
| Next unblocked batch | `G01-P3-F007` |
...
| Manifest SHA-256 | `aa7f32fabe36432c2dcacff030559012302d6d1a1503bd6c87144df8980ff85c` |
| Completion commit | — |
| Blocker | None |
...
| Required C0-C3 protocol families | 44 | 6 | 0 | 38 |
...
| Phase 3 — Protocol C0 and C1 | `InProgress` | [wire foundation](../development/protocol-wire.md), [packet catalog](../development/protocol-catalog.md), [handshake](../development/protocol-handshake-serverbound.md), required [clientbound](../development/protocol-login-clientbound.md)/[serverbound](../development/protocol-login-serverbound.md) login, [clientbound Play entry](../development/protocol-play-clientbound-entry.md), and both [clientbound](../development/protocol-configuration-clientbound.md)/[serverbound](../development/protocol-configuration-serverbound.md) configuration directions | Bounded transport, locked dispatch, terminal intention routing, complete required offline login ordering, both required configuration directions, and the ordered clientbound Play entry projection pass |
...
| Required protocol partitions | 44 | 44 families | 6 | 38 |
