...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P6-S010` |
| Next unblocked batch | `G01-P6-S011` |
...
| Manifest SHA-256 | `35800b54f23d4c7523e0f4085c7d4469835569d67783242faf6c9d37281eb2e7` |
| Completion commit | — |
| Blocker | None |
...
|---|---:|---:|---:|---:|
| `SourceSpecified` gameplay slices | 327 | 174 | 0 | 153 |
...
| Gameplay slice partitions | 55 | 331 slices | 176 | 155 |
