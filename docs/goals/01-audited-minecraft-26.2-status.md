...
|---|---|
| State | `InProgress` |
| Active batch | `G01-P9-O008` |
| Next unblocked batch | `G01-P9-O009` |
...
| Manifest SHA-256 | `b4e87291467903693a628682c68546b6e4d9d0f48f3a0df02d2b28603baeb0c5` |
| Completion commit | — |
| Blocker | None |
...
| C4 configuration gates | 14 | 7 | 0 | 7 |
