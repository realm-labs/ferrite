...
The current structural coverage checks 9,078 IDs and reports 333 IDs classified as `Unreviewed`:
82 blocks, 30 items, 37 entity types and 184 worldgen records. All 49 block-entity types now have
