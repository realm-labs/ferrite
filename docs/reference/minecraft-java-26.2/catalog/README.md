...
The current structural coverage checks 9,078 IDs and reports 655 IDs classified as `Unreviewed`:
189 blocks, 245 items, 37 entity types and 184 worldgen records. All 49 block-entity types now have
