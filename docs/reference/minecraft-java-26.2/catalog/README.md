...
The current structural coverage checks 9,078 IDs and reports 9 IDs classified as `Unreviewed`:
0 blocks, 0 items, 0 entity types and 9 worldgen records. All 49 block-entity types now have
...
eleven-modifier, 23-chain, 624-instance and 90-configured-holder audit in that owner; the remaining
9 worldgen records stay explicitly `Unreviewed` until their codec audits land. Registry entries outside
these gameplay categories remain discoverable in
