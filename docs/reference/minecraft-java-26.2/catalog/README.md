...
The current structural coverage checks 9,078 IDs and reports 820 IDs classified as `Unreviewed`:
338 blocks, 13 block-entity types, 248 items, 37 entity types and 184 worldgen
...
frequency-bearing vibration runtime, and trial spawner plus vault own their full state machines.
