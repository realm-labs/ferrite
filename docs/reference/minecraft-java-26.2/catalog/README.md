...
The current structural coverage checks 9,078 IDs and reports 809 IDs classified as `Unreviewed`:
336 blocks, 7 block-entity types, 245 items, 37 entity types and 184 worldgen
