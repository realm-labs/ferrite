...
The current structural coverage checks 9,078 IDs and reports 825 IDs classified as `Unreviewed`:
338 blocks, 15 block-entity types, three game rules, 248 items, 37 entity types and 184 worldgen
...
`BLK-COMMAND-AREA-001` owns the shared clone/fill/fillbiome limit. Trial-spawner and vault
