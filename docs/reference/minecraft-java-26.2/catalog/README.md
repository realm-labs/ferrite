...
The current structural coverage checks 9,078 IDs and reports 189 IDs classified as `Unreviewed`:
0 blocks, 0 items, 5 entity types and 184 worldgen records. All 49 block-entity types now have
