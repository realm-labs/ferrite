...
The current structural coverage checks 9,078 IDs and reports 185 IDs classified as `Unreviewed`:
0 blocks, 0 items, 1 entity type and 184 worldgen records. All 49 block-entity types now have
