...
The current structural coverage checks 9,078 IDs and reports 824 IDs classified as `Unreviewed`:
338 blocks, 15 block-entity types, two game rules, 248 items, 37 entity types and 184 worldgen
...
generic revenge suppression plus classic-neutral and Piglin universal targeting. Trial-spawner and vault
block/block-entity runtime own their complete encounter,
