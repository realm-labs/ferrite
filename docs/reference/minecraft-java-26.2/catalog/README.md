...
The current structural coverage checks 9,078 IDs and reports 840 IDs classified as `Unreviewed`:
341 blocks, 16 block-entity types, 14 game rules, 248 items, 37 entity types and 184 worldgen
