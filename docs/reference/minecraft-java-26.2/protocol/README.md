...
projection. World-border delta, sound, particle, and level-event projection are source-specified.
Remaining clientbound chat/score and other families plus C4 remain incomplete.
