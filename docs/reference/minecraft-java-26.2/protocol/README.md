...
projection. World-border delta, sound, and particle projection are source-specified. Remaining
clientbound chat/score, level-event and other families plus C4 remain incomplete.
