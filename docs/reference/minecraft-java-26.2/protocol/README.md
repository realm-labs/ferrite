...
projection. World-border delta projection is source-specified. Remaining clientbound chat/score,
level-event/particle/sound and other families plus C4 remain incomplete. Missing later-level details
