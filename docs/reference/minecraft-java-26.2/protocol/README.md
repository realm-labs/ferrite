...
projection. World-border delta projection and sound projection/filtering are source-specified.
Remaining clientbound chat/score, level-event/particle and other families plus C4 remain incomplete.
