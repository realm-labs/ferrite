...
- **Verification owners (`BLK-STATE-001`, `BLK-COPPER-GOLEM-STATUE-001`, `BLK-BELL-001`, `BLK-ENCHANTING-TABLE-001`, `BLK-LECTERN-001`, `BLK-BANNER-001`; state vectors in `EXP-BLK-001`, `EXP-BLK-008`, `EXP-BLK-009`, `EXP-BLK-010`, `EXP-BLK-011` and `EXP-BLK-012`):** The generic leaf fixes strict runtime transitions, lenient item-component patches, canonical identity and exhaustive report-schema checks; content leaves exhaust their exact state/component projections, including lectern state/content divergence and all 320 banner states.
...
- **Verification owners:** `BLK-PLACE-001` and `EXP-BLK-001` specify placement admission, interaction precedence, every block-item dispatch family, multi-position partial commits, components and side effects. `BLK-COPPER-GOLEM-STATUE-001`/`EXP-BLK-008`, `BLK-BELL-001`/`EXP-BLK-009`, `BLK-ENCHANTING-TABLE-001`/`EXP-BLK-010`, `BLK-LECTERN-001`/`EXP-BLK-011` and `BLK-BANNER-001`/`EXP-BLK-012` own their exact placement, component, loot and subtype edges. `BLK-BREAK-001`, `BLK-BREAKING-001` and `EXP-BLK-004` specify the generic breaking state machine and harvest transaction. `BLK-BREAK-HOOK-001`, `BLK-BREAK-CONTENT-001` and `EXP-BLK-005` exhaustively map and specify all 110 registered IDs with concrete break-hook behavior; neither placement nor generic breaking completion may hide those subtype transactions.
...
- **Verification owners (`BLK-UPDATE-001`, `BLK-COPPER-GOLEM-STATUE-001`, `BLK-BELL-001`, `BLK-BANNER-001`; `EXP-BLK-002`, `EXP-BLK-008`, `EXP-BLK-009`, `EXP-BLK-012`):** The generic leaf locks every bit value/named mask, phase order, abort semantics and limits; the content leaves fix their flags-3/11 callers, ignored results, state-family retention and bell/banner support writes.
...
- **Verification owners:** `BLK-UPDATE-001` and `EXP-BLK-002` lock generic lifecycle semantics. `BLK-TRIAL-SPAWNER-001`/`EXP-BLK-006`, `BLK-VAULT-001`/`EXP-BLK-007`, `BLK-COPPER-GOLEM-STATUE-001`/`EXP-BLK-008`, `BLK-BELL-001`/`EXP-BLK-009`, `BLK-ENCHANTING-TABLE-001`/`EXP-BLK-010`, `BLK-LECTERN-001`/`EXP-BLK-011`, `BLK-BANNER-001`/`EXP-BLK-012`, and `ENV-GEYSER-001`/`EXP-ENV-005` own concrete subtype transactions; other callbacks remain content-owned.
