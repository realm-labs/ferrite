...
- **Verification owner (`ENT-DAMAGE-001`, `ENT-BLOCK-001`, `ENT-DAMAGE-REDUCE-001`, `ENT-KNOCKBACK-001`; `EXP-ENT-002`):** Admission/cooldown, blocking and the complete defense/health transaction are source-specified. The shared velocity transaction remains an explicit independent leaf; no placeholder multiplier may cross its call boundary.
