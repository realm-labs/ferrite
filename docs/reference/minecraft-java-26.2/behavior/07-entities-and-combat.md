...
- **Verification owner (`ENT-LIFECYCLE-001`, `ITM-BOOKSHELF-001`, `BLK-COPPER-GOLEM-STATUE-001`, `BLK-LECTERN-001`; `EXP-ENT-*`, `EXP-ITM-010`, `EXP-BLK-008`, `EXP-BLK-011`):** The concrete leaves fix bookshelf/lectern item-entity callers plus statue restoration/conversion admission and already-mutated-source boundaries. Lock first/last tick for other spawn/remove-during-ticking, UUID collision, and re-add ordering after load.
