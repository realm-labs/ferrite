...
- **Verification owner (`CLI-EFFECT-001`, `ITM-ENDER-CHEST-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `ITM-JUKEBOX-001`, `BLK-COPPER-GOLEM-STATUE-001`, `ENV-GEYSER-001`; `EXP-CLI-003`, `EXP-ITM-008`, `EXP-ITM-009`, `EXP-ITM-010`, `EXP-ITM-011`, `EXP-BLK-008`, `EXP-ENV-005`):** Concrete leaves fix container/statue presentation and potent-sulfur plume/gas/bubble/sound cadence. Classify every remaining gameplay event as required, settings-droppable, or prediction-deduplicated, then record a vanilla client to verify relative tick and duplicate suppression.
