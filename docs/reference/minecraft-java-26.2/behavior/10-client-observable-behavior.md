...
- **Verification owner (`CLI-EFFECT-001`, `ITM-ENDER-CHEST-001`, `ITM-BARREL-001`; `EXP-CLI-003`, `EXP-ITM-008`, `EXP-ITM-009`):** Container leaves fix ender-chest lid/particle presentation and the barrel's positioned open/close sound emissions. Classify every remaining gameplay event as required, settings-droppable, or prediction-deduplicated, then record a vanilla client to verify relative tick and duplicate suppression.
