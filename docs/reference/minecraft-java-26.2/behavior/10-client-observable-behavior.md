...
- **Verification owner (`CLI-EFFECT-001`, `ITM-ENDER-CHEST-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `ITM-JUKEBOX-001`, `BLK-COPPER-GOLEM-STATUE-001`, `BLK-BELL-001`, `BLK-ENCHANTING-TABLE-001`, `BLK-LECTERN-001`, `ENV-GEYSER-001`; `EXP-CLI-003`, `EXP-ITM-008`, `EXP-ITM-009`, `EXP-ITM-010`, `EXP-ITM-011`, `EXP-BLK-008`, `EXP-BLK-009`, `EXP-BLK-010`, `EXP-BLK-011`, `EXP-ENV-005`):** Concrete leaves fix container/statue/bell/table/lectern presentation and potent-sulfur cadence. Classify every remaining emission as required, settings-droppable, or prediction-deduplicated, then verify timing.
