...
- **Verification owner (`PLY-INTERACT-001`, `ITM-ENDER-CHEST-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `ITM-JUKEBOX-001`, `BLK-COPPER-GOLEM-STATUE-001`, `BLK-BELL-001`, `BLK-ENCHANTING-TABLE-001`; `EXP-PLY-002`, `EXP-ITM-008`, `EXP-ITM-009`, `EXP-ITM-010`, `EXP-ITM-011`, `EXP-BLK-008`, `EXP-BLK-009`, `EXP-BLK-010`):** Concrete leaves fix their success/fallback transactions, including statue item precedence and bell/table main-hand try-empty-hand routing. Extract the remaining full decision table for every `InteractionResult` variant and both hands into tests.
