...
- **Verification owner (`PLY-INTERACT-001`, `ITM-ENDER-CHEST-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `ITM-JUKEBOX-001`; `EXP-PLY-002`, `EXP-ITM-008`, `EXP-ITM-009`, `EXP-ITM-010`, `EXP-ITM-011`):** The container leaves fix concrete success plus bookshelf/jukebox fallback transactions, including captured-versus-live occupancy. Extract the remaining full decision table for every `InteractionResult` variant and both hands from `26.2` client/server control flow into tests.
