...
- **Verification owner (`PLY-INTERACT-001`, `ITM-ENDER-CHEST-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `ITM-JUKEBOX-001`, `BLK-COPPER-GOLEM-STATUE-001`; `EXP-PLY-002`, `EXP-ITM-008`, `EXP-ITM-009`, `EXP-ITM-010`, `EXP-ITM-011`, `EXP-BLK-008`):** The concrete leaves fix their success/fallback transactions, including the statues' empty-stack pose use, secondary-use bypass, axe precedence and honeycomb-on-waxed quirk. Extract the remaining full decision table for every `InteractionResult` variant and both hands from `26.2` client/server control flow into tests.
