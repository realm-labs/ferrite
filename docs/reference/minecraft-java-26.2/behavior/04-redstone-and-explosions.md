...
- **Verification owners:** `RED-UPDATE-001` and `EXP-RED-*` retain the generic source/conductor/face matrix. `RED-DAYLIGHT-DETECTOR-001`/`EXP-RED-005` owns the daylight detector source transaction; `BLK-BELL-001`/`EXP-BLK-009` owns the bell's captured neighbor-signal rising/falling edge and nontransactional ring-before-POWERED write; `BLK-LECTERN-001`/`EXP-BLK-011` owns lectern weak/direct output and below-oriented notifications.
...
- **Verification owners:** `RED-COMPARATOR-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `ITM-JUKEBOX-001`, `BLK-COPPER-GOLEM-STATUE-001`, `BLK-LECTERN-001`, `EXP-RED-006`, `EXP-ITM-009`, `EXP-ITM-010`, `EXP-ITM-011`, `EXP-BLK-008` and `EXP-BLK-011` source-specify the comparator transaction and concrete projections, including statue pose outputs 1..4, jukebox item-defined output versus playing-defined source signal, and lectern page/content divergence plus its delay-two source pulse. `RED-DELAY-001` and `EXP-RED-002` retain repeater, observer and torch waveform work.
