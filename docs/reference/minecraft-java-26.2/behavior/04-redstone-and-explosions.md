...
- **Verification owners:** `RED-COMPARATOR-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `ITM-JUKEBOX-001`, `EXP-RED-006`, `EXP-ITM-009`, `EXP-ITM-010` and `EXP-ITM-011` source-specify the comparator transaction and three concrete projections, including the jukebox's item-defined output versus playing-defined source signal. `RED-DELAY-001` and `EXP-RED-002` retain repeater, observer and torch waveform work.
