...
- **Verification owners:** `RED-COMPARATOR-001`, `ITM-BARREL-001`, `ITM-BOOKSHELF-001`, `EXP-RED-006`, `EXP-ITM-009` and `EXP-ITM-010` source-specify the complete comparator transaction, the barrel's 27-slot provider/materialization formula and the bookshelf's unvalidated last-slot projection. `RED-DELAY-001` and `EXP-RED-002` retain repeater, observer and torch waveform work.
