...
- **Verification owner (`MOB-AI-001`; `EXP-MOB-002`):** Lock equal-priority traversal, every-tick/reduced goal cadence, Brain behavior ordering, and recovery after inactive-chunk gating.
