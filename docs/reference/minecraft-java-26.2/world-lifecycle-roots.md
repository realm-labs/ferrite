...
| Dimension travel, portals and world border | `net.minecraft.server.level.ServerPlayer#teleport`, `net.minecraft.world.level.portal.PortalForcer#findClosestPortalPosition`, `net.minecraft.world.level.portal.PortalForcer#createPortal`, `net.minecraft.world.level.border.WorldBorder#setCenter`, `net.minecraft.world.level.border.WorldBorder#setSize`, `net.minecraft.world.level.border.WorldBorder#lerpSizeBetween`, `net.minecraft.world.level.border.WorldBorder#tick` | `WGEN-PORTAL-001`, `WGEN-BORDER-001` and the mapped PlayerLifecycle transaction own admission, source removal, destination insertion, ticket use, passenger/camera policy and client convergence. A portal/border operation cannot bypass the same holder activity and publication gates; failure returns before destination membership, while successful cross-level player travel follows the exact respawn/difficulty/permission, removal, insertion, teleport and state-reprojection order in the player inventory. |
