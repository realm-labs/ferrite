...
projection at 84 block and 53 item fallback IDs. `ITM-BOOK-FAMILY-001` additionally closes Book,
...
- `InProgress` remains required while any of the 358 catalog IDs is `Unreviewed`, even though every
