...
projection at 84 block and 47 item fallback IDs. `ITM-BOOK-FAMILY-001` additionally closes Book,
...
- `InProgress` remains required while any of the 352 catalog IDs is `Unreviewed`, even though every
