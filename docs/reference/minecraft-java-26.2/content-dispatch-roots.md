...
| Game rules and global selectors | `net.minecraft.world.level.gamerules.GameRules#codec`, `net.minecraft.world.level.gamerules.GameRules#get`, `net.minecraft.world.level.gamerules.GameRules#set`, `net.minecraft.world.level.gamerules.GameRule#valueCodec` | Simulation, environment, command, player, entity and world leaves own each rule's read/write consequences. | Resolve the 17 remaining IDs from the exact [game-rule consumer inventory](game-rule-consumers.md), including defaults/validation, indirect callers, callbacks, persistence and client projection; shared storage/codec behavior is insufficient. |
...
- `InProgress` remains required while any of the 843 catalog IDs is `Unreviewed`, even though every
