...
projection at 84 block and 44 item fallback IDs. `ITM-BOOK-FAMILY-001` additionally closes Book,
...
- `InProgress` remains required while any of the 349 catalog IDs is `Unreviewed`, even though every
