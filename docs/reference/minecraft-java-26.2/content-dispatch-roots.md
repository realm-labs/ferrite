...
same five mob-food paths, progression and exact client dispatch at 84 block and 40 item fallback
IDs.
...
- `InProgress` remains required while any of the 345 catalog IDs is `Unreviewed`, even though every
