...
pickup/food/sharing/breeding, composting, progression and exact client dispatch at 84 block and
38 item fallback IDs.
...
- `InProgress` remains required while any of the 343 catalog IDs is `Unreviewed`, even though every
