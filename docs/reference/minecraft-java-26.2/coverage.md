...
current controlling rules. The catalog currently exposes 319 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 81 blocks, 17 items, 37 entity types and 184
