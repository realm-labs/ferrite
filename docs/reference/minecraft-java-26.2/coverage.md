...
current controlling rules. The catalog currently exposes 337 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 83 blocks, 33 items, 37 entity types and 184
