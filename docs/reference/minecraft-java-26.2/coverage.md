...
current controlling rules. The catalog currently exposes 309 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 75 blocks, 13 items, 37 entity types and 184
