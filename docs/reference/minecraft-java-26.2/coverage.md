...
current controlling rules. The catalog currently exposes 335 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 83 blocks, 31 items, 37 entity types and 184
