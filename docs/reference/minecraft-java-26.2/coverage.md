...
current controlling rules. The catalog currently exposes 311 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 75 blocks, 15 items, 37 entity types and 184
