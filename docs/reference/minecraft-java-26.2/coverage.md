...
Generated/verified on 2026-07-23 from server SHA-1 `823e2250d24b3ddac457a60c92a6a941943fcd6a` and
client SHA-1 `2dc72797acbc1b63fc16a11c4ac393605f453754`.

## Documentation

- Stable parent rules: 65/65, each referenced by at least one leaf rule.
- Implementation-level leaf rules: 162, spread across all ten subsystems.
- Directed experiment definitions: 115; all currently `planned`, so none is incorrectly counted as
  confirming evidence.
- Source locators: 2,214 across 787 classes, verified by `javap -p -s` against locked jars and the
...
| decorated_pot_pattern | 24 | `982ccb083b866e9058a6f59d9b9e5f27179dc852` |
...
current controlling rules. The catalog currently exposes 678 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 212 blocks, 245 items, 37 entity types and 184
