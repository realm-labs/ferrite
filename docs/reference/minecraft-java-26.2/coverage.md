...
current controlling rules. The catalog currently exposes 367 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 84 blocks, 62 items, 37 entity types and 184
