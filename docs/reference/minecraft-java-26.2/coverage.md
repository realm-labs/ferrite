...
current controlling rules. The catalog currently exposes 327 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 82 blocks, 24 items, 37 entity types and 184
