...
current controlling rules. The catalog currently exposes 362 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 84 blocks, 57 items, 37 entity types and 184
