...
current controlling rules. The catalog currently exposes 664 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 198 blocks, 245 items, 37 entity types and 184
