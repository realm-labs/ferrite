...
current controlling rules. The catalog currently exposes 343 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 84 blocks, 38 items, 37 entity types and 184
