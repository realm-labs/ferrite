...
current controlling rules. The catalog currently exposes 831 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 338 blocks, 15 block-entity types, nine game
