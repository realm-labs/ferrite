...
current controlling rules. The catalog currently exposes 665 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 199 blocks, 245 items, 37 entity types and 184
