...
current controlling rules. The catalog currently exposes 315 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 78 blocks, 16 items, 37 entity types and 184
