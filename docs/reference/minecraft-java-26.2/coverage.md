...
current controlling rules. The catalog currently exposes 333 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 82 blocks, 30 items, 37 entity types and 184
