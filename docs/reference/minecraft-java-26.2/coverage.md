...
current controlling rules. The catalog currently exposes 837 `Unreviewed` IDs instead of hiding
them behind broad `Special` or `DataOnly` fallbacks: 341 blocks, 16 block-entity types, 11 game
